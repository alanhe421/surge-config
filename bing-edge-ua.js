(async () => {
  ...
  if ($environment.system === 'macOS') {
    ...
    // iOS
    headers['User-Agent'] =
    'Mozilla/5.0 (iPhone; CPU iPhone OS 16_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/16.3 Mobile/15E148 Safari/605.1.15 BingSapphire/1.0.410218002';
